# youngdev_interns__tasksin whic i have learnt about different python concepts like
# file hanling
# classes & objects
# list, tuples, dictionary
# funcions

This project includes python programs 
...
💡 Concepts used: loops, recursion, and mathematical operations.
...
💡 Concepts used: recursion, loops, and function logic.
...
Takes a user-input string and prints its reverse form.
💡 Concepts used: string slicing, loops, and user input.
...
A command-line To-Do application that allows users to add, view, and delete tasks — all stored in a file.
💡 Concepts used: file handling, lists, functions, and simple data persistence.
